...
for m in model_types:
    ...
    for fold in range(0, n_folds):
        ...
        df_pd = pd.DataFrame(data=preds, columns=["pd_class0", "pd_class1", "pd_class2"])
        df_gt = pd.DataFrame(data=test_y, columns=["gt_class0", "gt_class1", "gt_class2"])
