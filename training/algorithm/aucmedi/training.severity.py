...
# AUCMEDI libraries
from aucmedi import input_interface, Neural_Network, Batchgenerators_Augmentation
...
# Define output architecture label
...
val_gen = DataGenerator_MetaData(val_x, path_ct, metadata=val_m, labels=val_y,
                          batch_size=batch_size, img_aug=None, shuffle=False,
                          subfunctions=sf_list, resize=None,
                          standardize_mode=sf_standardize,
                          grayscale=True, prepare_images=False,
                          sample_weights=None, seed=None,
